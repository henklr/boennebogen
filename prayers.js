const prayers = {
  ...
  creed_orthodox: { 
    ...
    body: "Vi tror på én Gud, den almægtige Fader, himmelens og jordens skaber, alt det synlige og usynlige. Og på én Herre, Jesus Kristus, Guds enbårne Søn, født af Faderen før al tid; lys af lys, sand Gud af sand Gud; født, ikke skabt; af samme væsen som Faderen, ved hvem alt er skabt; som for os mennesker og for vor frelse steg ned fra himlene og blev kød ved Helligånden af Jomfru Maria og blev menneske; korsfæstet for os under Pontius Pilatus, led og blev begravet; opstod på den tredje dag ifølge skrifterne; opfor til himlene og sidder ved Faderens højre hånd; og skal atter komme i herlighed for at dømme levende og døde; og hans rige skal være uden ende. Og på Helligånden, Herren og levendegøreren, som udgår fra Faderen, som tillige med Faderen og Sønnen tilbedes og herliggøres, som har talt ved profeterne. Og på én, hellig, katolsk og apostolisk Kirke. Vi bekender én dåb til syndernes forladelse, vi forventer de dødes opstandelse og den kommende verdens liv. Amen." 
  },
  morningPrayer: { 
    title: "Morgenbøn", 
